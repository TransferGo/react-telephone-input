...
var ReactTelephoneInput = React.createClass({
    ...
    getCountryDropDownList: function getCountryDropDownList() {
        ...
        var countryDropDownList = map(this.state.preferredCountries.concat(this.props.onlyCountries), function (country, index) {
            ...
            var countryName = this.props.translations[countryCode] ? this.props.translations[countryCode] : country.name;
            ...
            return React.createElement('li', {
                ...
                onClick: this.handleFlagItemClick.bind(this, country) }, React.createElement('div', { className: inputFlagClasses, style: this.getFlagStyle() }), React.createElement('span', { className: 'country-name' }, countryName), React.createElement('span', { className: 'dial-code' }, '+' + country.dialCode));
        }, this);
