...
var ReactTelephoneInput = React.createClass({
    ...
    render: function render() {
        ...
        var selectedCountryName = this.props.translations[this.state.selectedCountry.iso2] ? this.props.translations[this.state.selectedCountry.iso2] : this.state.selectedCountry.name;
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { ref: 'selectedFlag', onClick: this.handleFlagDropdownClick, className: 'selected-flag', title: selectedCountryName + ': +' + this.state.selectedCountry.dialCode },
                    React.createElement(
                        'div',
